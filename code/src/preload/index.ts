...
const bridge = {
  ...
  sessions: {
    ...
    createPersonal: (): Promise<SessionSnapshot> => ipcRenderer.invoke('sessions:create-personal'),
    setTrust: (request: SessionTrustRequest): Promise<SessionSnapshot> => ipcRenderer.invoke('sessions:set-trust', request),
